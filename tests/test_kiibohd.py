...
def test_kiibohd_simple(kiibohd_controller_repo):
    ...
    args = [
        ...
        '--emitter', 'kiibohd',
        '--def-template', 'kll/templates/kiibohdDefs.h',
        '--map-template', 'kll/templates/kiibohdKeymap.h',
        '--hid-template', 'kll/templates/kiibohd_usb_hid.h',
        '--pixel-template', 'kll/templates/kiibohdPixelmap.c',
